...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar  3 11:29:27 2026
...
summary_net = flattening_net.SummaryGNN(W_full, p + 1, 64, 64, 16)
...
checkpoint = keras.callbacks.ModelCheckpoint(
    filepath='checkpoints/bym2_ca_p6.weights.h5',
    monitor='val_loss',
    save_best_only=True,
...
output_fp = Path("checkpoints") / "bym2_spatialgnn_p1_v3.keras"
