...
echo "----------------------------------------------------------------"
echo "Running src/RDA_data_setup.py from: $(pwd)"

python -u -m src.RDA_data_setup

# 3. Run baseline MCMC analyses
...
echo "----------------------------------------------------------------"
echo "Running src/RDA_fit_joint_network.py from: $(pwd)"
