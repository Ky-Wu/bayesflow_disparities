...
beta_summary_net = summary_networks.SummaryGNN(W_full, 1, 64, 64, 16)
...
history = beta_workflow.fit_online(epochs = 50, 
                              batch_size = 64,
...
history = var_workflow.fit_online(epochs = 70, 
                                  batch_size = 64,
                                  iterations_per_epoch = 1000,
                                  validation_data = 64,
